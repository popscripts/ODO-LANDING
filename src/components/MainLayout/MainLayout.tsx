...
function MainLayout({screen, loaded}: Props) {
    ...
    return (
        <Wrapper as={motion.article} layout>
            ...
            {!mobile && <ScreenshotWrapper as={motion.div} initial={{y: "100vh", display: "none"}} animate={{y: 0, display: "block"}} transition={{delay: 2, duration: 1}}>
                <Screenshot as={motion.div} initial={{transform: "rotateY(15deg)" }} animate={{transform: "rotateY(-15deg)", boxShadow: "3px 0 0 #0A0A0AFF, 0 0 1px #0A0A0AFF"}} transition={{delay: 2.5, duration: 1}}>
